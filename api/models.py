...
class Question(models.Model):
    ...
    answered_count = models.IntegerField(default=int(0))
    # tag = ArrayField(models.IntegerField(blank=True, null=True), blank=True, null=True)
...
class Answer(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, null=True, related_name='answer')
